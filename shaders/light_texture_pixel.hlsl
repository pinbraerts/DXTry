...
float4 main(PS_INPUT input): SV_TARGET {
	...
	float4 material_diffuse = diffuse.Sample(sam, input.tex_pos);
	float4 material_ambient = material_diffuse;
	float4 material_specular = specular.Sample(sam, input.tex_pos);
